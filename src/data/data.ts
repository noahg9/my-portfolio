...
export const professionalJourney = [
    {
        ...
        description: "Developing an AI-powered CV engine using Java and React.",
        logo: "/saply-ai.avif",
    },
    {
        ...
        description: "Developed an AI-driven HR chatbot using Java and Angular, deployed on AWS.",
        logo: "/we-plus.png",
    },
    {
